...
./parser < sample_input2.c > output2.txt || { echo "Parser execution failed"; exit 1; }
echo "Execution completed. Check output2.txt."
./parser < sample_input3.c > output3.txt || { echo "Parser execution failed"; exit 1; }
echo "Execution completed. Check output3.txt."
